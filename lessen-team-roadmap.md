...
| GATE-REASON-STD-1 | Reasoning Unified Task-Shell Human Evidence Review | no | Direct-comment human evidence gate after reasoning adoption/playability work. Packet must present playable output, screenshots, validators, usability-agent thinking traces, carried flags, and no-authority boundaries like `GATE-TASK-FAMILY-1`. No old interactive interview protocol. |
...
| Scale Gate 1 | Foundation Hardening Scale Gate | no | Blocked until the Product Proof Track closes, including `GATE-REASON-STD-1`, `GATE-PRODUCT-3P`, and `REV-STD-1`, or a human waiver explicitly records consequences. |
