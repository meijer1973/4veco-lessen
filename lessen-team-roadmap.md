...
## Current Books 3 and 4 v3 integration — 2026-09-17

`BOOK34-V3-INTEGRATION-20260917`: supplied writing/assembly/R1–R5 repairs complete; repository integration prepared/in PR. Shared editable/PDF delivery: [edities/books34-v3](edities/books34-v3/README.md). Book 3: 6+4+4; Book 4: 5+7+5; Year 1: 55. Long-run competition is first assessed in 4.1.1; old v2 cao/vakbonden is deferred, new 4.3.5 remains mixed practice. The 31 targets remain candidates awaiting independent review. Books 1–2 and the v2 edition are preserved. Five timing questions (3.1.2, 3.1.3, 3.1.5, 4.2.4, 4.2.5), later-year cao placement/time, companion acceptance and publication remain open. No merge or deployment performed.
