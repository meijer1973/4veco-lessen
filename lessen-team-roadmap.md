...
| REASON-PLAY-1 | Reasoning Playability And Usability-Agent Test | no | After route adoption, run separate usability agents against the playable reasoning route. Record whether agents immediately understand the goal, the clickable tokens/buttons, feedback, retry, and next action, or whether trial-and-error is needed. Repair blockers before human review. |
