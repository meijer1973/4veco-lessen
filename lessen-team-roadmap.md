...
-> GRAPH-REFINE-1 / MATH-REFINE-1 / REASON-REFINE-1 / CHECK-Q2-PLAN (planning/preparation only)
-> L1.7B-Q2
-> GATE-L1.7B-Q2
-> Scale Gate 1
```
...
| GRAPH-REFINE-1 | Graph Route Operation-Chain Hardening Plan | no | **PLATFORM PLANNING/PREPARATION ONLY.** Prepare a plan to harden graph/table route operation-chain coverage before any target-equivalent exit-ticket reliance. No implementation, generated output, target-equivalent claims, diagnostics, mastery/sequencing, Scale Gate 1, or product use. |
| MATH-REFINE-1 | Math Target-Operation-Chain Hardening Plan | no | **PLATFORM PLANNING/PREPARATION ONLY.** Prepare a plan to harden math/calculation route coverage for `1.1.2` target operations: calculation/work capture, final answer, percentage/index notation, unit/notation handling, and short explanation where needed. No implementation, generated output, target-equivalent claims, diagnostics, mastery/sequencing, Scale Gate 1, or product use. |
| REASON-REFINE-1 | Reasoning Answer-Form Integration Plan | no | **PLATFORM PLANNING/PREPARATION ONLY.** Prepare a plan to harden reasoning around answer-form MTUs, constructed response, causal chains, source use, and correction-model-style answer construction. No implementation, generated output, target-equivalent claims, diagnostics, mastery/sequencing, Scale Gate 1, or product use. |
| CHECK-Q2-PLAN | Target-Equivalent Exit-Ticket Implementation Plan | no | **PLATFORM/LESSON PLANNING/PREPARATION ONLY.** Prepare the implementation plan for `L1.7B-Q2` while preserving the advisory short check as a separate local advice surface. No exit-ticket implementation, paragraph-completion language, diagnostics, mastery/sequencing, Scale Gate 1, or product use. |
...
- Book 2 Part A should wait until the remaining foundation blockers clear.
  ...
  GRAPH-UX-2, MATH-UX-2, REASON-UX-2, GAME-ARCH-1, and GAME-ARCH-2.
  Still-open blockers are GATE-ENGINE-1, L1.7B-Q2,
...
- Treat `GATE-MTU-H4` through `MTU-H4C` as closed platform answer-form
  ...
  reasoning task-shell integration, and `GAME-ARCH-1`/`GAME-ARCH-2` have
  closed architecture decision and planning. `GATE-ENGINE-1` is now the active
...
- Use the L2.0 exit-ticket checklist, GATE-L1.7B carried flags,
  ...
  architecture plan, and the SYNC-4 shared task-shell specification as entry
  conditions for `GATE-ENGINE-1`.
...
- Continue companion controlled-scope work only where it supports the L1.7A
  ...
  L1.7C-MATH/L1.7B-MAP/L1.7B-P23/SPEC-ET-1/EX-LESSON-1/GAME-UX-3A/ENGINE-OP-1/SKILLMAP-OP-1/GRAPH-UX-2/MATH-UX-2 foundation, and the open
...
- Use the L1.7A readiness decision, L1.7B-C contract-and-stop outcome,
  ...
  work. GRAPH-UX-2 and MATH-UX-2 have since closed graph/math task-shell
  integration proof. Complete reasoning integration, GATE-ENGINE-1,
...
- L1.7B-C through GATE-L1.7B closed the checkpoint product boundary only.
  ...
  graph/table task-shell integration proof, and MATH-UX-2 is closed as
  math/calculation task-shell integration proof. REASON-UX-2 through
  GATE-ENGINE-1 must prove the remaining practice engines operationally before L1.7B-Q2
