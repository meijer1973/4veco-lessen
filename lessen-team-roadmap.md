...
| REASON-ANSWERFORM-2 | Reasoning Answer-Form And Source-Use Scaffolds | no | Connect reasoning practice to A97/A98/A99/A81 answer-form scaffolds, decide the mode 2 error-detection route and mode 4 classification-with-explanation route, and define source-based explanation adoption without target-equivalent claims. |
