...
| L1.4 | First Pipeline Regression Paragraph | **2026-05-12** | **CLOSED 2026-05-12 PASS WITH FLAGS.** Built `1.1.2 Percentages en indexcijfers` through the platform-owned student-web profile after L1.5O. Delivered native student-facing HTML companions, interactive shared data, shell pages, PPTX + semantic presentation-v2 web deck, companion review, quality-ref refresh, and `_paragraph-plan.md`; no new Word exports were generated. Validation green: `validate-paragraph --mode complete --profile student-web`, `validate-paragraph --mode part-a --profile publisher-print`, local link checker, focused engine data Jest, and presentation-v2 screenshot QA. Flags: formal teacher/student review and broader browser screenshot QA for non-presentation pages still need a separate review gate before using 1.1.2 as a scaling-quality visual baseline. Sprint plan: `L1.4-sprint-plan.md`. |
...
Updated: 2026-05-12 (L1.4 close) — `1.1.2 Percentages en indexcijfers` now has the complete student-web companion set generated from platform source without new Word exports. Green gates: Part A publisher-print validation, complete student-web validation, local link checker, focused engine data Jest, and presentation-v2 screenshot QA. Remaining flags are review-quality, not build-blocking: teacher/student review and broader browser screenshot QA for the non-presentation pages should happen before treating this as a scaling visual baseline.
