...
-> CHECK-Q2-PLAN (remaining planning/preparation only)
-> L1.7B-Q2
-> GATE-L1.7B-Q2
-> Scale Gate 1
```
...
needs A81 source-use scaffolding plus graph-axis repair. Remaining authorized
planning/preparation lane is CHECK-Q2-PLAN. No implementation, generated
