...
- Use the L1.7A readiness decision, L1.7B-C contract-and-stop outcome,
  ...
  TASK-FAMILY-LABEL-1, TASK-FAMILY-MATCH-1, and TASK-FAMILY-TWO-TIER-1 have since
  ...
  exact matching-pairs runtime support, and answer-plus-reason two-tier-choice
  runtime support.
  Complete the remaining
  Product Proof Track
  through TASK-FAMILY-ASSERTION-1,
  GATE-TASK-FAMILY-1,
