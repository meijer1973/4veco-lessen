...
| TASK-CONTEXT-RUNTIME-1 | Shared Task Context Runtime | no | Implement context rendering above task lists in the shared task shell with desktop/mobile/dark proof, playable lab, screenshots, and checker coverage. This proves context placement only, not exam/textbook ingestion. |
