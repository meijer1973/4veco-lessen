...
`BOOK34-CHAT-IMPORT-OUTLINES-1`: Writing/assembly complete; import and structural migration prepared/in PR. Book 3: 6+4+4=14; Book 4: 4+7+6=17; Year 1: 55. Selected v2 outlines are current structural baselines. Target approval, companion acceptance and merge remain separate. The delivered PDFs and editable sources are preserved. This finite integration supersedes older Book 3/4 writing instructions for these editions. Historical targets remain version-qualified in `archive/blueprints/book34-pre-chat-2026/`; they confer no approval on a reused ID. Trade closes Book 3; monopoly opens Book 4; labour equilibrium is retained across 4.3.2/3/4/6. See the platform `reports/reference-planning/BLUEPRINT-CHANGE-REVIEW-BOOK34-CHAT-20260914.md` and `reports/sprints/BOOK34-CHAT-IMPORT-OUTLINES-1-result.md`.
...
`product-vision.md` defines strategic direction and trade-off logic.
`product-end-state.md` defines the operational student route and completeness
standard. `companion-core-specifications.md` defines companion/game/check and
task-shell requirements.
...
- A flag blocks only the claim or authority it names. Route-specific rendered
  proof blocks product-route adoption, not planning/adoption-preparation;
  target-equivalence flags block target-equivalent claims, not task-family
  acceptance.

| Sprint | Name | Completed | Current State |
|--------|------|-----------|---------------|
| BOOK34-CHAT-IMPORT-OUTLINES-1 | Import completed Books 3/4 and adopt selected outlines | no | Writing/assembly complete; import and structural migration prepared/in PR. Book 3: 6+4+4=14; Book 4: 4+7+6=17; Year 1: 55. Selected v2 outlines are current structural baselines. Target approval, companion acceptance and merge remain separate. |
...
| TASK-FAMILY-FORMULA-1 | Formula Builder Task-Family Implementation | **2026-06-01** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform added `formula_builder` as a deterministic shared task-shell family with formula-block bank, ordered construction zone, formula category metadata, clear/remove/reorder controls, distractor validation, default no-reuse behavior, exact `{ tokens }` response matching including extra-key rejection, shared UI helpers, wrapper collection support, focused tests, rendered report fixture, proof JSON, and checker. Round 1 returned REVISE for extra response keys being accepted; corrections resolved this and round 2 passed with flags. Product-route screenshots and rendered interaction proof remain required before adoption; formula equivalence beyond exact sequences and calculation execution remain separate follow-up work. No source-data writes, generated output, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. |
| TASK-FAMILY-CLOZE-1 | Cloze Text Task-Family Implementation | **2026-06-01** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform added `cloze_text` as a deterministic shared task-shell family with typed inline blanks, accepted-value matching, bounded `requiredTextGroups`, per-blank `rejectText`, exact `{ blanks }` response matching including raw-map and extra-key rejection, shared UI helper, wrapper collection support, focused tests, rendered report fixture, proof JSON, checker, and lead-review records. Route-specific rendered proof required before product-route adoption; `requiredTextGroups` is bounded phrase matching, not broad semantic answer evaluation. No source-data writes, generated output, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. |
| TASK-FAMILY-MULTI-1 | Multi-Select Task-Family Implementation | **2026-06-01** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform added `multi_select` as a deterministic shared task-shell family with exact-set order-insensitive matching, strict string-only `{ values }` response shape, duplicate/unknown/extra-key rejection, required distractor option, practice-only partial feedback for missing required options and selected distractors, distinct `.ts-multi-option` / `data-multi-option-id` UI, wrapper collection support, focused tests, rendered report fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for numeric/object response-id coercion; corrections resolved this and round 2 passed with flags. Route-specific rendered proof required before product-route adoption; multi-select cannot replace richer target-operation proof. No source-data writes, generated output, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. |
| TASK-FAMILY-ORDER-1 | Step-Ordering Task-Family Implementation | **2026-06-01** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform added `step_ordering` as a deterministic shared task-shell family with answer/distractor step-bank schema, at least two answer steps and one distractor, no neutral/no-distractor loopholes, full `expected.order` answer-step coverage, exact `{ order }` response matching with raw-array, array-with-`order`, non-string, duplicate, unknown, missing, and extra-key rejection, practice-only order feedback, distinct `.ts-step-*` UI, wrapper collection support, focused tests, rendered report fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for array-with-`order` response-shape acceptance; corrections resolved this and round 2 passed with flags. Route-specific rendered proof required before product-route adoption; `step_ordering` proves procedure control only and cannot replace final calculation, graph/table, source-chain, or constructed-response proof. No source-data writes, generated output, target-equivalent reliance, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. |
| TASK-FAMILY-SOURCE-1 | Source Value And Chain Builder Implementation | **2026-06-01** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform added `source_value_selection` and `source_chain_builder` as deterministic shared task-shell families for multi-value source selection, role assignment, and source-to-value-to-operation-to-answer-to-conclusion chain construction, with strict response-shape validation, practice-only feedback, wrapper collection support, proof artifacts, and lead-review records. Product-route adoption requires later route-specific rendered proof; source-chain construction is not target-equivalent proof without paired operation tasks and later review. No source-data writes, generated output, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. |
| TASK-FAMILY-LABEL-1 | Label-Placement Task-Family Implementation | **2026-06-01** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform added `label_placement` as a deterministic shared task-shell family with label bank, visual target region, target buttons, placement summary, strict `{ placements }` response validation, practice-only feedback, wrapper collection support, focused tests, rendered report fixture, proof JSON, checker, and lead-review records. Round 1 returned REVISE for missing symmetric negative coverage; corrections resolved this and round 2 passed with flags. Product-route adoption requires later route-specific rendered proof; label placement is representation-placement support only, not complete graph/table target-equivalent proof. No source-data writes, generated output, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. |
| TASK-FAMILY-MATCH-1 | Matching-Pairs Task-Family Implementation | **2026-06-02** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform added `matching_pairs` as a deterministic shared task-shell family with left/right item banks, accessible descriptions, one-to-one-only answer coverage, strict `{ pairs }` response validation, practice-only feedback, matching-specific UI controls, wrapper collection support, focused tests, rendered report fixture, proof JSON, checker, and lead-review records. Product-route adoption requires later route-specific rendered proof; Many-to-one matching unsupported; conditional capability note only; matching pairs cannot replace richer target-operation proof. No source-data writes, generated output, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. |
| TASK-FAMILY-TWO-TIER-1 | Two-Tier Choice Task-Family Implementation | **2026-06-02** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform added `two_tier_choice` as a deterministic shared task-shell family with separate answer/reason option banks, accessible descriptions, exact `{ answer, reason }` response validation, neutral practice-only feedback, two-tier UI controls, wrapper collection support, focused tests, rendered report fixture, proof JSON, checker, historical archive read-only evidence, and lead-review records. Product-route adoption requires later route-specific rendered proof; feedback must not become diagnostic or misconception-profile output; two-tier choice cannot replace constructed-response or target-equivalent proof. No source-data writes, generated output, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. |
| TASK-FAMILY-ASSERTION-1 | Assertion-Reason Task-Family Implementation | **2026-06-02** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform added `assertion_reason` as a deterministic shared task-shell family with required assertion/reason text, labelled relation option bank, minimum four described relation options, exact `{ value }` response validation, neutral practice-only selected/expected relation feedback, assertion-specific UI controls, wrapper collection support, focused tests, rendered report fixture, proof JSON, checker, historical archive read-only evidence, and lead-review records. Product-route adoption requires later route-specific rendered proof; feedback must not become diagnostic or misconception-profile output; assertion-reason cannot become generic quiz variety, default reasoning-game format, constructed-response replacement, or target-equivalent proof. No source-data writes, generated output, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product-wide use was authorized. |
| GATE-TASK-FAMILY-1 | Structured Choice And Construction Task-Family Review | **2026-06-02** | **CLOSED PASS WITH FLAGS / PLANNING INPUT ONLY.** Platform gate closed at reviewed remote commit `e35b7c58eded4d4d4544fbd39f8c5365a58785c9`. Accepted structured choice and constrained construction task families only as planning input for later bounded adoption-preparation. No generated lesson output, source-data mutation, engine implementation from this gate, product-route adoption, target-equivalent completion language, diagnostics, adaptive routing, mastery/sequencing, student-facing AI, summative use, PV, Scale Gate 1, or product use was authorized. |
| ROADMAP-FLAG-CLEANUP-1 | Roadmap Flag Semantics Cleanup | **2026-06-02** | **CLOSED ROADMAP CLEANUP / NO GENERATED OUTPUT.** Platform cleaned active roadmap flag language so route-specific rendered proof blocks product-route adoption, target-equivalence flags block target-equivalent claims, many-to-one matching is a conditional unsupported capability, and historical archive no-change evidence is a read-only invariant. Many-to-one matching unsupported; conditional capability note only. Historical archive remains read-only. No generated output, implementation, source-data mutation, product-route adoption, target-equivalent claim, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product use is authorized. |
...
| REASON-STD-1 | Reasoning Game Unified Exercise Migration | **2026-06-02** | **CLOSED PASS WITH FLAGS / PLATFORM RUNTIME MAPPING ONLY.** Platform added engine-emitted shared task-shell tasks for reasoning modes 0, 1, 3, and 5; generated fixture/proof JSON from actual `ReasoningEngine` `taskShellTask` objects; strengthened checker/Jest proof so wrong standard-task orders are rejected; kept mode 2 `error_detection` deferred and mode 4 `classification_with_explanation` refactor-scoped. Decision: keep the reasoning engine as content provider and wrap/refactor around shared families; rebuild only modes that cannot consume shared route/task shell cleanly. No generated lesson output, source-data mutation, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product use was authorized. |
| REASON-ADOPT-1 | Reasoning Shared-Shell Route Adoption | yes | Adopt the wrapped standard-family tasks into the generated Book 1 reasoning route with route-specific playable proof, desktop/mobile/dark screenshots, route-panel evidence, and validators. Preserve mode 2 and mode 4 held/refactor status unless separately reviewed. No target-equivalent claims, diagnostics, mastery/sequencing, Scale Gate 1, or product-wide use. |
| REASON-PLAY-1 | Reasoning Playability And Usability-Agent Test | **2026-06-02** | **CLOSED PASS WITH FLAGS / EVIDENCE ONLY.** Platform ran separate usability-agent evidence, deterministic rendered screenshot proof, and lead-review round 1/round 2. Two counted usability agents returned PASS WITH FLAGS from generated proof/screenshot review; deterministic rendered capture proves modes 0, 1, 3, and 5 are playable with screenshots. No blocking repair was required. Carried flags: dual feedback density, mobile route-panel placement, dark-theme consistency, compact controls, mode 3 bridge-only status, modes 2/4 held, and usability agents reviewed proof/screenshots rather than fresh live-clicking. This is practice-route playability proof only, not target-equivalent reasoning readiness or product authority. |
| REASON-ANSWERFORM-2 | Reasoning Answer-Form And Source-Use Scaffolds | **2026-06-02** | **CLOSED PASS WITH FLAGS / GENERATED OUTPUT THROUGH PLATFORM DEPLOY ONLY.** Platform added local practice answer-form scaffold cues for A97/A98/A99/A81 patterns, kept A81 modifier-only with an underlying answer form, kept A97/A98/A99 distinct, preserved mode 2 as local error repair, and kept mode 4 held for classification-with-explanation redesign. Generated Book 1 reasoning output changed through platform deploy only. Carried flags: late planning review accepted as protocol variance, A99 lacks a live 1.1.1/1.1.2 evidence case, A81 remains future source-use modifier only, mode 2/mode 4 need reviewed adoption, mode 3 remains ordered-chain bridge, mobile route panel can sit below first viewport, and no target-equivalent/product authority is authorized. |
| GATE-REASON-STD-1 | Reasoning Unified Task-Shell Human Evidence Review | **2026-06-03** | **REVIEWED / REVISION ROUTED.** Human comments accepted the packet only as local shared-shell reasoning-practice evidence with flags and returned `REVISE` for adoption/replacement readiness. The water-scarcity task lacked visible wrong-answer context, mode 3 wording over-suggested visual flow construction, stale evidence text remained, and current tasks cannot replace the reasoning game. No generated output, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product use was authorized. |
| REASON-REVISION-0 | Reasoning Gate Comment Resolution And Revision Routing | **2026-06-03** | **CLOSED ROUTING / NO GENERATED OUTPUT.** Platform recorded the split verdict from `GATE-REASON-STD-1`: local evidence accepted with flags, adoption/replacement revised. |
| REASON-CONTEXT-1 | Reasoning Context And Label Revision Proof | **2026-06-03** | **CLOSED REVIEW-ONLY PROOF / NO GENERATED LESSON OUTPUT.** Platform produced playable revision proof that the water-scarcity task has visible wrong-answer context, mode 3 uses reasoning-chain language rather than visual-flow overclaim, and replacement authority remains denied. |
| REASON-REPLACE-AUDIT-1 | Reasoning Game Replacement Audit | **2026-06-03** | **CLOSED AUDIT / NO IMPLEMENTATION.** Platform audited reasoning modes and source/example follow-ups as keep/wrap/refactor/rebuild/hold before any replacement claim. Names UX, mode 2, mode 4, A81 source-use, A99 example, and visual-flow follow-up work. |
| GATE-REASON-REVISION-1 | Reasoning Revision Evidence Human Review | **2026-06-03** | **CLOSED PASS WITH FLAGS / PLANNING-ADOPTION PREPARATION ONLY.** Platform gate closed at reviewed remote commit `13c460df35219b3b52c30098dcfc50796f3654e3`. Repaired the previous `GATE-REASON-STD-1` revise defects: visible water-scarcity wrong-answer context, mode 3 reasoning-chain wording, stale mode-disposition cleanup, replacement audit, and playable proof. No generated lesson output, source-data mutation, product-route adoption, reasoning-game replacement, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or product use was authorized. |
| REASON-UX-HARDEN-1 | Reasoning UX Hardening Plan | no | Plan and prove repairs for feedback hierarchy, compact controls, mobile route placement, dark-theme consistency, and manual playability evidence. Planning/adoption-preparation only. |
...
| SPRINT-PROTOCOL-HARDEN-2 | Sprint Protocol Evidence Hardening | **2026-06-03** | **CLOSED PASS / PROTOCOL ONLY.** Platform added command-log evidence, command-log validation, result/bundle command-evidence enforcement for 2026-06-03+ sprints, lead-review substance validation, batch-closure blocking, negative fixtures, and lead-review round 1/round 2. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use was authorized. |
| SYNC-ROADMAP-EXAM-REPAIR-1 | Roadmap Exam Repair Alignment | **2026-06-03** | **CLOSED PASS WITH FLAGS / ROADMAP SYNC ONLY.** Platform aligned the platform and lesson roadmaps after rollback and protocol hardening, corrected false-complete lesson context/ingestion statuses, made `EXAM-SOURCE-AUTH-1` the next repair sprint, replaced old broad source reconstruction, task transformation, and human gate identifiers with the actual-exam/textbook repair sequence, and added a checker for duplicate blocker rows. Flag: checker hardens duplicate handling for named blocker rows, not a global duplicate-ID policy. No implementation, generated lesson output, source-data mutation, protected reference mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use is authorized. |
| EXAM-SOURCE-AUTH-1 | Exam Source Authority Contract | **2026-06-03** | **CLOSED PASS WITH FLAGS / AUTHORITY CONTRACT ONLY.** Platform added an authority contract and checker for `vw-1022-a-25-1-o:opgave-1:question-3`, requiring `sourceAuthority.kind: external_primary`, official exam item ID, overlay path, prompt PDF, correction PDF, source material ID, table-only source-material matching, Zoohee table value matching, answer-model refs, EUR 649 threshold evidence, exact forbidden-term rejection for `official-style`, `exam-style`, `local review data`, `local official-style source`, and `reconstructed local source`, and full boundary flags set to false. No source reconstruction, task-shell context rendering, task transformation, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use is authorized. |
...
| TASK-CONTEXT-SPEC-1 | Shared Task Context Contract | yes | Closed 2026-06-03. Mirrored platform closure for the context-contract-only schema, fixture, and checker in `reports/json/task-context-spec1-contract.json` and `build-scripts/sprints/check-task-context-spec1.js`. Proves `contextBlocks`, task `contextRefs`, source-authority provenance, required block coverage, accessibility/caption rules, and rejection coverage. No runtime rendering, source reconstruction, task transformation, generated lesson output, product adoption, PV, Scale Gate, or student use authorized. Next: `TASK-CONTEXT-RUNTIME-1`. |
| TASK-CONTEXT-RUNTIME-1 | Shared Task Context Runtime | yes | Closed 2026-06-04. Platform added context rendering above shared task-shell task lists with stable block IDs, task references, captions/source labels, alt/accessibility text, mobile/dark proof, no exit-ticket hint leakage, playable review lab, screenshots, and checker coverage. This proves context placement/runtime behavior only; no exam/textbook ingestion, source reconstruction, generated lesson output, product-route adoption, target-equivalent proof, PV, Scale Gate, or student/product use authorized. Next: `CONTEXT-VISUAL-STD-1`. |
| CONTEXT-VISUAL-STD-1 | Source Context Visual Standard | yes | Closed 2026-06-04 as a standard/checker sprint. Platform added `reports/sprints/CONTEXT-VISUAL-STD-1-visual-standard.md`, `reports/json/context-visual-std1-contract.json`, and `build-scripts/sprints/check-context-visual-std1.js`. Defines source context visual rules for semantic tables, reconstructed SVG graphs/figures/flowcharts, formula boxes, source cards, captions, labels, color tokens, typography, spacing, mobile behavior, dark mode, axis/legend conventions, SVG sizing, alt text, source-label rules, source-output parity proof, and reviewer evidence. Covers all eight context block types and absorbs the visual-source scope previously implied by `DUAL-CODING-STD-1`. No source reconstruction, exam/textbook ingestion, generated lesson output, runtime CSS/UI implementation, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, PV, diagnostics, mastery/sequencing, Scale Gate, or student/product use authorized. Next: `SOURCE-RECONSTRUCT-2-ACTUAL-EXAM`. |
| SOURCE-RECONSTRUCT-2-ACTUAL-EXAM | Actual Exam Source Reconstruction | **2026-06-04** | **CLOSED PASS / SOURCE RECONSTRUCTION ONLY.** Platform added governed reconstruction for `vw-1022-a-25-1-o:opgave-1:question-3`: normalized source markdown, source map, visual-fidelity notes, reviewer comparison, semantic table/context blocks, reconstruction JSON, rendered review lab, desktop/mobile/dark screenshots, proof JSON, capture harness, and checker tied to the official prompt/correction PDFs. No task transformation, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate, or student/product use authorized. Next: `TASK-INGEST-TRANSFORM-2-ACTUAL-EXAM`. |
| TASK-INGEST-TRANSFORM-2-ACTUAL-EXAM | Actual Exam Source Exercise Transformation | **2026-06-04** | **CLOSED PASS / TASK TRANSFORMATION ONLY.** Platform added review-ready task transformation for `vw-1022-a-25-1-o:opgave-1:question-3`: exact reconstructed context blocks, six shared task-family cards, operation-chain trace, answer-form trace, task-family map, reviewer notes, rendered review lab, desktop/mobile/dark screenshots, proof JSON, capture harness, and checker tied to the official source reconstruction. Preserves source selection, formula conversion, step ordering, visible calculation work, source-chain construction, and threshold-direction formulation while rejecting source-only, choice-only, and final-answer-only reductions. No textbook transformation, human gate closure, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate, or student/product use authorized. Next: `TASK-INGEST-TRANSFORM-3-TEXTBOOK`. |
| TASK-INGEST-TRANSFORM-3-TEXTBOOK | Textbook Source Exercise Transformation | **2026-06-04** | **CLOSED PASS / TEXTBOOK-SOURCE TASK TRANSFORMATION ONLY.** Platform added review-ready owned textbook-source transformation for `1.1.3 Grafieken en tabellen`: governed source map, six context blocks, nine shared task-family cards, visual variant map, operation-chain trace, answer-form trace, task-family map, reviewer notes, rendered review lab, desktop/mobile/dark screenshots, proof JSON, capture harness, and checker. Preserves table reading, P-Q axis convention, graph procedure, point placement, interpolation source values, graph reading, visible percent-change calculation work, source-chain reasoning, and claim-answer form. Records the paragraph-taught and also source-valid 50 percent intervals without claiming official exam/external-primary authority. No human gate closure, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate, or student/product use authorized. Next: `GATE-SHARED-TASK-INGEST-REPAIR-1`. |
| CI-REMOTE-1 | GitHub Actions Remote Platform CI | **2026-06-04** | **CLOSED PASS WITH FLAGS / REMOTE CI ONLY.** Platform added GitHub Actions workflow `platform-ci` with job `validate-platform`, sibling checkout for `4veco-platform` and `4veco-lessen`, `npm ci`, platform validators, report/roadmap/URL-index checks, diff hygiene, bounded diagnostic artifact upload, and branch protection requiring context `validate-platform`. Remote run `26953558150` passed on commit `c70cf1cf9320a5de9f8a2f4e490b934ae822246b`; artifact `platform-ci-diagnostics` uploaded. Carried flag: monitor GitHub `windows-latest` runner-label migration notice if CI later fails without code changes. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. Next: `GATE-SHARED-TASK-INGEST-REPAIR-1`. |
| GATE-SHARED-TASK-INGEST-REPAIR-1 | Shared Task Context And Ingestion Repair Human Review | **2026-06-05** | **CLOSED PASS WITH FLAGS / ADOPTION-PREPARATION ONLY.** Platform gate closure evidence records final direct human review at reviewed remote evidence commit `95f0eda5f51eb7868cb947dc3e8f081957b2afb4`. It accepts Repair 4 and reviewer correction pass for source-context ingestion readiness only. Carried flags remain for later shared-task hardening, graph substitute maturity, carried-value chaining, progressive calculation feedback, prompt/source/support separation, delayed reveal policy, and the secondary 50 percent follow-up. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, broad product use, or student/product use authorized. Next: continue `CHECK-SHORT-EXIT-2`. |
| SHARED-TASK-INGEST-PLAYABLE-REPAIR-1 | Shared Task Ingest Playable Lab Repair | **2026-06-04** | **CLOSED PASS WITH FLAGS / REVIEW-LAB REPAIR ONLY.** Platform replaced generic review-shell controls with real task-family affordances, separated prompt/source/support with support collapsed by default, repaired concrete prompts and source-chain labels, added semantic checking, wrong/retry/corrected/completed/mobile/dark proof, stricter task-affordance and support-policy checkers, verification review, lead-review round 1/round 2, refreshed gate packet evidence, and passing gate packet checker. Carried flag: future checker hardening should assert exact visible source-chain labels and rendered prompt/source parity. No gate closure, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. |
| SHARED-TASK-INGEST-PLAYABLE-REPAIR-2 | Target-Task Simplification And Visual QA Repair | **2026-06-05** | **CLOSED PASS WITH FLAGS / REVIEW-LAB TARGET-ECONOMY REPAIR ONLY.** Platform reduced the actual-exam lab to source values, calculation, and conclusion; reduced the textbook lab to primary `graph_construction_substitute` plus two follow-ups; moved prompts out of source panes; hid completed graph output before graph-construction success; added graph-workspace visual QA proof; added target-task economy reports/checkers; refreshed the human-review packet; and kept `GATE-SHARED-TASK-INGEST-REPAIR-1` open. Renewed human review carried interaction-quality blockers into `SHARED-TASK-INGEST-PLAYABLE-REPAIR-3`: actual exam question visibility, compact source-value selection, carry-forward conclusion, click-to-place graph construction, delayed graph labels/scales, and source-pane readability proof. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. |
| SHARED-TASK-INGEST-PLAYABLE-REPAIR-3 | Interaction Quality And Source Pane Repair | **2026-06-05** | **CLOSED REVIEW-LAB REPAIR ONLY / FOURTH REVIEW STILL REVISE.** Platform added visible original actual-exam question in the right task pane, compact source-cell selection, task-3 carry-forward with constrained direction, click-to-place textbook graph construction, delayed graph labels/scales, source-pane readability proof, screenshots, checkers, lead-review artifacts, refreshed packet evidence, and remote publication on `codex/shared-task-ingest-repair3`. Carried blockers into `SHARED-TASK-INGEST-PLAYABLE-REPAIR-4`: line still appears as a separate completed graph, grid visibility needs tuning, 50 percent follow-up affordance is unclear, exam task 1 is not useful enough, task-2 unit validation and targeted feedback are weak, support after repeated failed attempts is missing, duplicate visible Bron/Tabel labels remain, and visual QA must hard-fail those issues. No generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. |
| SHARED-TASK-INGEST-PLAYABLE-REPAIR-4 | Final Interaction Clarity Repair | **2026-06-05** | **CLOSED PASS WITH FLAGS / REVIEW-LAB REPAIR EVIDENCE ONLY.** Platform preserved three-card economy and review-only boundaries while replacing exam select-all-numbers task 1 with conceptual setup, accepting `649` plus reasonable yearly unit variants and `22x12 = 264, 264 + 385 = 649` shortcut work, adding targeted feedback and progressive support, drawing the textbook graph line inside the same workspace, attaching axis selectors to the graph, keeping grid visible from the start while hiding labels/scale until correct axes, using table-derived graph ticks, simplifying the 50 percent follow-up with conclusion acceptance and shared `interval_halving_check` focus-plan evidence, removing duplicate visible Bron/Tabel labels, strengthening visual QA/checkers/screenshots, adding lead-review/verification artifacts, refreshing the review packet, and keeping `GATE-SHARED-TASK-INGEST-REPAIR-1` open. No gate closure, generated lesson output, protected reference mutation, source-data mutation, product-route adoption, target-equivalent proof, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. |
...
| CHECK-SHORT-EXIT-2 | Implement Both Check Types For First Three Paragraphs | no | Post-review repair sequence remains open until renewed direct human comments and closure evidence exist. The earlier platform retry packet is superseded. The inserted platform sequence `CHECKSURFACE-POLICY-REGRESSION-1` -> `CHECKSURFACE-EXCELLENCE-REDESIGN-1` -> `CHECKSURFACE-EXCELLENCE-AUDIT-3P` -> `CHECKSURFACE-GATE-RETRY-EXCELLENT-1` is complete as packet preparation: policy/checker added, `1.1.3` short/exit redesigned, Book 1 output regenerated through platform deploy, proof/screenshots refreshed, audit matrix recorded, and renewed packet prepared. Next action after push: direct human review comments on `GATE-CHECK-SURFACE-EXCELLENT-1-first-three-check-surfaces-review`. Keep generated lesson output deploy-only; no new completion language, product-route adoption, diagnostics, mastery/sequencing, PV, Scale Gate 1, or student/product use authorized. |
| CHECKSURFACE-POLICY-REGRESSION-1 | Check-Surface Policy And Regression Memory | **2026-06-06** | **CLOSED PASS / POLICY AND REGRESSION ONLY.** Platform added durable shared-task/check-surface policy plus negative fixtures/checker. No generated lesson output or product authority. |
| CHECKSURFACE-EXCELLENCE-REDESIGN-1 | Check-Surface Excellence Redesign | **2026-06-06** | **CLOSED PASS WITH FLAGS / GENERATED OUTPUT THROUGH PLATFORM DEPLOY ONLY.** Platform repaired `1.1.3` short-check and exit-ticket source/runtime behavior and regenerated Book 1 output through deploy. `1.1.3` remains a held candidate; no new completion language or product authority. |
| CHECKSURFACE-EXCELLENCE-AUDIT-3P | First-Three Check-Surface Excellence Audit | **2026-06-06** | **CLOSED PASS WITH FLAGS / AUDIT ONLY.** Platform recorded six-surface audit proof for `1.1.1`-`1.1.3`. No gate closure or product authority. |
| CHECKSURFACE-GATE-RETRY-EXCELLENT-1 | Renewed Excellent Check-Surface Gate Packet | **2026-06-06** | **PACKET PREPARATION COMPLETE / HUMAN COMMENTS NOT STARTED.** Platform prepared a new direct human-review packet that supersedes the old retry packet and cites refreshed proof. No gate closure before returned comments and resolution log. |
| SCALE-PROOF-3P | Three-Paragraph Product Proof | no | Blocked until `CHECK-SHORT-EXIT-2` and `GATE-PRODUCT-3P` supply closure evidence or a human waiver explicitly records consequences. Produce student-path proof for landing, Start, Leer, Oefen, skill map, practice task with source/context where relevant, advisory short check, target-equivalent exit ticket, feedback, and next action for `1.1.1`-`1.1.3`. |
...
-> TASK-FAMILY-FORMULA-1 (closed PASS WITH FLAGS)
...
-> TASK-FAMILY-LABEL-1 (closed PASS WITH FLAGS)
-> TASK-FAMILY-MATCH-1 (closed PASS WITH FLAGS)
-> TASK-FAMILY-TWO-TIER-1 (closed PASS WITH FLAGS)
-> TASK-FAMILY-ASSERTION-1 (closed PASS WITH FLAGS)
-> GATE-TASK-FAMILY-1 (closed PASS WITH FLAGS; planning input only)
-> ROADMAP-FLAG-CLEANUP-1 (closed roadmap cleanup)
...
| TASK-FAMILY-FORMULA-1 | Formula Builder Task-Family Implementation | **2026-06-01** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform implemented formula construction from formula blocks or symbols before calculation-work tasks with category validation, exact sequence matching, wrapper support, proof artifacts, and lead-review records. Product-route adoption and screenshots remain later work. Records: platform `reports/sprints/TASK-FAMILY-FORMULA-1-result.md`. |
...
| TASK-FAMILY-LABEL-1 | Label-Placement Task-Family Implementation | **2026-06-01** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform implemented shared label-placement runtime support and proof artifacts only. Product-route adoption and generated-route screenshots remain later work. Records: platform `reports/sprints/TASK-FAMILY-LABEL-1-result.md`. |
| TASK-FAMILY-MATCH-1 | Matching-Pairs Task-Family Implementation | **2026-06-02** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform implemented shared matching-pairs runtime support and proof artifacts only. Product-route adoption requires later route-specific rendered proof; Many-to-one matching unsupported; conditional capability note only; target-operation reliance remains later work. Records: platform `reports/sprints/TASK-FAMILY-MATCH-1-result.md`. |
| TASK-FAMILY-TWO-TIER-1 | Two-Tier Choice Task-Family Implementation | **2026-06-02** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform implemented shared two-tier-choice runtime support and proof artifacts only. Product-route adoption, generated-route screenshots, diagnostic/misconception-profile output, and target-operation reliance remain later work. Records: platform `reports/sprints/TASK-FAMILY-TWO-TIER-1-result.md`. |
| TASK-FAMILY-ASSERTION-1 | Assertion-Reason Task-Family Implementation | **2026-06-02** | **CLOSED PASS WITH FLAGS / NO GENERATED LESSON OUTPUT.** Platform implemented shared assertion-reason runtime support and proof artifacts only. Product-route adoption, generated-route screenshots, diagnostic/misconception-profile output, and target-operation reliance remain later work. Records: platform `reports/sprints/TASK-FAMILY-ASSERTION-1-result.md`. |
| GATE-TASK-FAMILY-1 | Structured Choice And Construction Task-Family Review | **2026-06-02** | **CLOSED PASS WITH FLAGS / PLANNING INPUT ONLY.** Platform gate closed at reviewed remote commit `e35b7c58eded4d4d4544fbd39f8c5365a58785c9`; downstream work is planning/adoption-preparation only until route-specific proof and later gates authorize product-route use. |
| ROADMAP-FLAG-CLEANUP-1 | Roadmap Flag Semantics Cleanup | **2026-06-02** | **CLOSED ROADMAP CLEANUP / NO GENERATED OUTPUT.** Platform cleaned active roadmap flag semantics so flags block only the claim or authority they name. Records: platform `reports/sprints/ROADMAP-FLAG-CLEANUP-1-result.md`. |
...
| REV-STD-1 | Core-Spec Review Standard Hardening | **2026-06-10** | **CLOSED PASS WITH FLAGS / REVIEW-STANDARD AND FLAG-DISPOSITION ONLY.** Platform and lesson review standards now require `specifications/product-end-state.md`, the original sprint or gate specification, non-negotiable requirements, a core-requirement checklist, and `core_requirement_met` / `quality_improvement_available` / `minor_carry_flag` / `scale_blocker` / `core_spec_failure` finding classifications. Future PASS WITH FLAGS cannot carry missing core requirements. Residual product-proof blockers remain typed in the REV-STD-1 flag-disposition report; this closure does not authorize product-route adoption, the current `1.1.2` Golden Workbench transfer, new target-equivalent claims, diagnostics, mastery/sequencing, PV, Scale Gate 1, broad product use, or student/product use. |
| Scale Gate 1 | Foundation Hardening Scale Gate | no | **BLOCKED.** `SPEC-ET-1`, `EX-LESSON-1`, `GAME-UX-3A`, `ENGINE-OP-1`, `SKILLMAP-OP-1`, `GRAPH-UX-2`, `MATH-UX-2`, `REASON-UX-2`, `GAME-ARCH-1`, `GAME-ARCH-2`, `GATE-ENGINE-1`, `GRAPH-REFINE-1`, `MATH-REFINE-1`, `REASON-REFINE-1`, `CHECK-Q2-PLAN`, `L1.7B-Q2`, `GATE-L1.7B-Q2`, `L1.7B-Q2-COPY`, `L1.7B-Q2-D31-STRUCT`, `SYNC-PRODUCT-1`, `MTU-H4C`, `L1.7C-MATH`, `L1.7B-MAP`, `L1.7B-P23`, `GATE-SHARED-TASK-INGEST-REPAIR-1`, and `REV-STD-1` are closed, but Scale Gate 1 may not run until the Product Proof Track reaches `CHECK-SHORT-EXIT-2`, `SCALE-PROOF-3P`, and `GATE-PRODUCT-3P`, or those blockers are explicitly waived by human decision with stated consequences. Scale Gate 1 must use `specifications/product-end-state.md` as the north-star baseline and may not treat engine architecture, shared skill-map runtime, answer-form MTUs, exam-target route traces, task-shell runtime support, advisory short-check output, graph-route practice output, math-route practice output, reasoning self-check output, the historical exact local `1.1.2` completion copy, or the current held `1.1.2` Golden Workbench transfer as broad scale proof. If target-equivalent status is waived for other paragraphs, landing-page `Check` must be labelled as local practice check or checkpoint-only status, not paragraph-completion proof. Scale Gate 1 may authorize controlled production only, not adaptive diagnostics, mastery/sequencing, student-facing AI, summative use, PV projection, or PV machine promotion. |
...
Updated: 2026-05-25 (L1.7B-R platform handoff) - L1.7B-R created its operational resume plan and stopped before implementation. The lesson team issued `archive/sprints/L1.7B-R/L1.7B-R-platform-support-request.md` for platform `GAME-UX-2`, because the platform roadmap still treats the exit-ticket checkpoint engine as a future support lane pending GATE-EX5 or explicit waiver. L1.7B-R remains not checkpoint-closed; GATE-L1.7B remains blocked until a source-controlled generated checkpoint surface exists and is reviewed.

Historical conditions (2026-05-26): Lesson output commit `5c47961269096c21a7d50bbc97c71de7984ff6e1` now contains generated `1.1.1` checkpoint output and landing-page `Check` activation through platform scripts only. Technical QA is green, but L1.7B-R remains open pending human review. The lead review must explicitly resolve the internal skill-scope metadata question: generated checkpoint metadata uses `A43`/`A04`, while the `1.1.1` paragraph plan names `B01`/`B02`. GATE-L1.7B remains required before Scale Gate 1.
...
Historical conditions (2026-05-26): Lesson output was regenerated through platform deploy only. L1.7C-MATH is ready for human review but not closed.

Historical conditions (2026-05-26): Targeted platform revision now uses student-facing skill labels in result next-action copy, replaces visible dependency-node IDs with `Vaardigheid`, and extends screenshot QA to exercise the skill-tree page to a post-result state. Focused evidence shows `Volgende: Prijsindex (CPI) berekenen` and `skillTreeResultHasInternalCode: false`. At this point L1.7C-MATH was focused-recheck ready but not closed; the later close entry records the final verdict.

Updated: 2026-05-26 (L1.7C-MATH close) - Focused human recheck accepted L1.7C-MATH as PASS WITH FLAGS. The old skill-tree math game is restored as primary `Rekenen` for scoped `1.1.2` and `1.1.3`, `stappenplan.html` remains `Rekenstappen` support, and unscoped `1.1.1` remains collapsed as `Brede vaardigheidskaart`. Carried flags: skill-tree progress language must remain practice-only, restored math is not target-exercise-readiness evidence, keyboard/focus-order proof should strengthen before scale, and scoped skilltree comments need cleanup. Scale Gate 1 remains blocked by the remaining exit-ticket metadata/readiness and review-standard sprints.
...
Historical conditions (2026-05-30): The supported task families now include
...
Historical conditions (2026-05-31): It found real practice progress
...
panels are empty or mis-scoped. Active next sprint is GAME-ARCH-2. No target-equivalent completion
...
live-output checklist. GATE-ENGINE-1 has since
...
separate proof task for L1.7B-Q2/GATE-L1.7B-Q2. `1.1.1`
...
needs graph-axis repair plus A81 source-use with an underlying answer form. Future L1.7B-Q2 must select one paragraph and resolve or explicitly scope its
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l05-green-gate-handoff). Original ledger status
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l11-first-companion-technical-pilot). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l13a-basic-html-layout-and-front-end-usability). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l13c-powerpoint-presentation-improvement). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l15a-easy-layout-round-2). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
Team B reference draft ([uitleg vaardigheden team b.html (historical draft)](https://github.com/meijer1973/4veco-lessen/blob/57b31a1f4a3d2aa0da3945abbc5a7a0ee5d05e6a/_team-b-reference/1.1.1/uitleg%20vaardigheden%20team%20b.html)) into Team
...
Retirement note (2026-09-09): the [vaardigheden draft](https://github.com/meijer1973/4veco-lessen/blob/57b31a1f4a3d2aa0da3945abbc5a7a0ee5d05e6a/_team-b-reference/1.1.1/uitleg%20vaardigheden%20team%20b.html) and [voorkennis draft](https://github.com/meijer1973/4veco-lessen/blob/57b31a1f4a3d2aa0da3945abbc5a7a0ee5d05e6a/_team-b-reference/1.1.1/uitleg%20voorkennis%20team%20b.html) were removed from the current checkout. The selected C4 keuzekaart and price-versus-cost scaffolds are implemented in the [platform vaardigheden builder](https://github.com/meijer1973/4veco-platform/blob/main/build-scripts/content/book-1/b1-111-vaardigheden.js); the retained [post-L1.5V companion review](https://github.com/meijer1973/4veco-lessen/blob/57b31a1f4a3d2aa0da3945abbc5a7a0ee5d05e6a/Boek%201%20-%20Grondslagen%2C%20vraag%20en%20aanbod/1.1%20Hoofdstuk%20Economisch%20denken%20en%20rekenen/1.1.1%20Schaarste%20en%20economisch%20denken/1.1.1-companion-visual-review.md) identifies the leftover pair as unused and outside the student route. The original sprint verdicts and unrelated flags remain unchanged.
...
1. **Whole-sprint planning sub-agent.** Survey: current source for both
   ...
   Team B's [uitleg vaardigheden team b.html (historical draft)](https://github.com/meijer1973/4veco-lessen/blob/57b31a1f4a3d2aa0da3945abbc5a7a0ee5d05e6a/_team-b-reference/1.1.1/uitleg%20vaardigheden%20team%20b.html); the §1.1.1 voorkennis
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l17a-scaling-readiness-and-modality-gate-review). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l17b-c-exit-ticket-companion-contract). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-spec-end-state-product-end-state-specification-canonicalization). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l17c-math-restore-skill-tree-math-game--four-game-architecture-integrity). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l17c-0-shared-skill-map-engine-contract). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
Completed execution: [full baseline](archive/roadmaps/snapshots/lessons-team-20260910.md#sprint-l17d-paragraph-landing-page-information-architecture-cleanup). Original ledger status
and the following recorded conditions are retained; this is not new closure.
...
- [course_blueprint_v4.md (identical platform owned source)](https://raw.githubusercontent.com/meijer1973/4veco-platform/main/references/owned/course-blueprint-v4.md) still uses the old four-theory-chapters plus
...
- Continue companion controlled-scope work only where it supports the L1.7A
  ...
  L1.7C-MATH/L1.7B-MAP/L1.7B-P23/SPEC-ET-1/EX-LESSON-1/GAME-UX-3A/ENGINE-OP-1/SKILLMAP-OP-1/GRAPH-UX-2/MATH-UX-2/REASON-UX-2/GATE-ENGINE-1/GRAPH-REFINE-1/MATH-REFINE-1/REASON-REFINE-1/CHECK-Q2-PLAN/L1.7B-Q2/GATE-L1.7B-Q2/L1.7B-Q2-COPY/L1.7B-Q2-D31-STRUCT/SYNC-PRODUCT-1/CHECK-SHORT-EXIT-1/STANDARD-EXERCISES-1/TASK-SHELL-UX-2/TASK-FAMILY-CHOICE-1/TASK-FAMILY-CONSTRUCT-1/TASK-FAMILY-CLOZE-TILE-1/TASK-FAMILY-SENTENCE-1/TASK-FAMILY-FORMULA-1/TASK-FAMILY-CLOZE-1/TASK-FAMILY-MULTI-1/TASK-FAMILY-ORDER-1/TASK-FAMILY-SOURCE-1/TASK-FAMILY-LABEL-1/TASK-FAMILY-MATCH-1/TASK-FAMILY-TWO-TIER-1/TASK-FAMILY-ASSERTION-1/GATE-TASK-FAMILY-1/ROADMAP-FLAG-CLEANUP-1/SPRINT-PROTOCOL-HARDEN-2/SYNC-ROADMAP-EXAM-REPAIR-1 foundation, and the open Product Proof Track:
  GAME-ROUTE-AFFORDANCE-1,
  SKILLMAP-PRODUCT-1, REASON-STD-1, DUAL-CODING-STD-1, ENGINE-UNIFY-1,
  EXAM-SOURCE-AUTH-1, TASK-CONTEXT-SPEC-1, TASK-CONTEXT-RUNTIME-1,
  CONTEXT-VISUAL-STD-1, SOURCE-RECONSTRUCT-2-ACTUAL-EXAM,
  TASK-INGEST-TRANSFORM-2-ACTUAL-EXAM,
  TASK-INGEST-TRANSFORM-3-TEXTBOOK,
  GATE-SHARED-TASK-INGEST-REPAIR-1, SHARED-TASK-INGEST-PLAYABLE-REPAIR-1,
  SHARED-TASK-INGEST-PLAYABLE-REPAIR-2, SHARED-TASK-INGEST-PLAYABLE-REPAIR-3,
  SHARED-TASK-INGEST-PLAYABLE-REPAIR-4,
  CHECK-SHORT-EXIT-2, CHECKSURFACE-POLICY-REGRESSION-1,
  CHECKSURFACE-EXCELLENCE-REDESIGN-1, CHECKSURFACE-EXCELLENCE-AUDIT-3P,
  CHECKSURFACE-GATE-RETRY-EXCELLENT-1, REV-STD-1,
...
- Use the L1.7A readiness decision, L1.7B-C contract-and-stop outcome,
  ...
  TASK-FAMILY-LABEL-1, TASK-FAMILY-MATCH-1, TASK-FAMILY-TWO-TIER-1, and TASK-FAMILY-ASSERTION-1 have since
  ...
  exact-set multi-select runtime support, step-ordering runtime support,
  source-value/source-chain runtime support, label-placement runtime support,
  exact matching-pairs runtime support, answer-plus-reason two-tier-choice
  runtime support, and sparse assertion-reason relation-judgement runtime
  support.
  Complete the remaining
  Product Proof Track
  through GAME-ROUTE-AFFORDANCE-1, SKILLMAP-PRODUCT-1, REASON-STD-1,
  DUAL-CODING-STD-1, ENGINE-UNIFY-1, CHECK-SHORT-EXIT-2,
  SCALE-PROOF-3P, and GATE-PRODUCT-3P, or explicitly waive
