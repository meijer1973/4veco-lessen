...
if __name__=='__main__':
    ...
    build(pages,'Boek_3_H2_Volkomen_concurrentie','Boek 3 · Hoofdstuk 3.2 · Volkomen concurrentie')
    for source,stem,title,kind in [('Antwoorden.md','Boek_3_H2_Antwoorden','Antwoorden · Volkomen concurrentie','answer'),('Docenteninformatie.md','Boek_3_H2_Docenteninformatie','Docenteninformatie · Volkomen concurrentie','teacher')]:
