...
@page {size:A4; margin:17mm 18mm 17mm 19mm;
 ...
 @top-right {content:"2.2  Elasticiteit";font-family:Lato,sans-serif;font-size:8.5pt;color:#536777;}
...
html{font-family:Lato,"DejaVu Sans",sans-serif;font-size:11.8pt;line-height:1.37;color:#183247;}
body{margin:0;}
...
def build_chapter():
    ...
    out=embedded_html('\n'.join(html),'Boek 2 · Hoofdstuk 2.2 · Elasticiteit')
    (OUTPUT/'Boek_2_H2_Elasticiteit.html').write_text(out)
    doc=HTML(string=out,base_url=str(ROOT)).render()
    doc.write_pdf(OUTPUT/'Boek_2_H2_Elasticiteit.pdf')
    page_map=[]
    ...
    (ROOT/'2.2 Elasticiteit – hoofdstuk.md').write_text('\n\n<div class="page-break"></div>\n\n'.join(p['body'] for p in PAGES))
