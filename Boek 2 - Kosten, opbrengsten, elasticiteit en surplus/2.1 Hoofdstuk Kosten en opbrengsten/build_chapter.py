...
PARAGRAPHS = [
    ("2.1.1 Kostenstructuren", "paragraaf", "antwoorden"),
    ("2.1.2 Opbrengsten, winst en break-even", "paragraaf", "antwoorden"),
    ("2.1.3 Marginale kosten en marginale opbrengsten", "paragraaf", "antwoorden"),
    ("2.1.4 Gemengde opgaven", "opgaven", "antwoorden"),
]
...
@page {
  ...
  @bottom-left   { content: "Hoofdstuk 2.1 - Kosten en opbrengsten"; font-family: Arial, sans-serif; font-size: 9pt; color: #555; }
...
def assemble(kind):
    ...
    if kind == "hoofdstuk":
        ...
        parts.append(f"# Antwoorden hoofdstuk 2.1 - Kosten en opbrengsten\n")
...
def wrap_exercises(html):
    """Wrap each exercise block for print page-break control."""
    token_re = re.compile(
