...
# ---------------------------------------------------------------------------
# Front page content (from blueprint chapter 1: Economic Thinking & Math)
# ---------------------------------------------------------------------------
...
PARAGRAPHS = [
    {
        "dir": MODULE / "1.1.1 Schaarste en economisch denken",
        "para": "1.1.1 Schaarste en economisch denken \u2013 paragraaf.md",
        "answers": "1.1.1 Schaarste en economisch denken \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
    {
        "dir": MODULE / "1.1.2 Percentages en indexcijfers",
        "para": "1.1.2 Percentages en indexcijfers \u2013 paragraaf.md",
        "answers": "1.1.2 Percentages en indexcijfers \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
    {
        "dir": MODULE / "1.1.3 Grafieken en tabellen",
        "para": "1.1.3 Grafieken en tabellen \u2013 paragraaf.md",
        "answers": "1.1.3 Grafieken en tabellen \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
    {
        "dir": MODULE / "1.1.4 Gemengde opgaven",
        "para": "1.1.4 Gemengde opgaven \u2013 opgaven.md",
        "answers": "1.1.4 Gemengde opgaven \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
]
...
@page {
  ...
  @bottom-left   { content: "Hoofdstuk 1 \u2014 Economisch denken en rekenen"; font-family: Arial, sans-serif; font-size: 9pt; color: #555; }
...
def assemble_answers():
    ...
    parts = ["# Antwoorden Hoofdstuk 1 \u2014 Economisch denken en rekenen"]
...
if __name__ == "__main__":
    ...
    md_to_pdf(chapter_md, "1.1 Economisch denken en rekenen \u2013 hoofdstuk")

    print("\n=== Building answer booklet PDF ===")
    md_to_pdf(answers_md, "1.1 Economisch denken en rekenen \u2013 antwoorden")
