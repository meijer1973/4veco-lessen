"""Build styled PDF from markdown files following the econ-pdf-builder skill."""
...
@page {
  ...
  @bottom-left   { content: "1.1.3 Grafieken en tabellen"; font-family: Arial, sans-serif; font-size: 9pt; color: #555; }
...
if __name__ == "__main__":
    ...
    for stem in ["paragraaf", "opgaven", "antwoorden"]:
        md_file = os.path.join(base, f"1.1.3 Grafieken en tabellen \u2013 {stem}.md")
        pdf_file = os.path.join(base, f"1.1.3 Grafieken en tabellen \u2013 {stem}.pdf")
