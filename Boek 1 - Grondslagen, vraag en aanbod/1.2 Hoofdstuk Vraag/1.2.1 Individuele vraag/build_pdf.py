...
@page {
  ...
  @bottom-left   { content: "1.2.1 Individuele vraag"; font-family: Arial, sans-serif; font-size: 9pt; color: #555; }
...
if __name__ == "__main__":
    ...
    for stem in ["paragraaf", "opgaven", "antwoorden"]:
        md_file = os.path.join(base, f"1.2.1 Individuele vraag \u2013 {stem}.md")
        pdf_file = os.path.join(base, f"1.2.1 Individuele vraag \u2013 {stem}.pdf")
