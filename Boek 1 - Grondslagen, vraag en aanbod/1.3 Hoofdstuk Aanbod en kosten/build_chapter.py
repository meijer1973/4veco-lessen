...
Produces:
  - 1.3 Aanbod en kosten – hoofdstuk.md / .html / .pdf
  - 1.3 Aanbod en kosten – antwoorden.md / .html / .pdf
"""
...
# ---------------------------------------------------------------------------
# Front page content (from blueprint chapter 3: Supply & Cost Structures)
# ---------------------------------------------------------------------------
...
PARAGRAPHS = [
    ...
    {
        "dir": MODULE / "1.3.2 Kostenstructuren",
        "para": "1.3.2 Kostenstructuren \u2013 paragraaf.md",
        "answers": "1.3.2 Kostenstructuren \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
    {
        "dir": MODULE / "1.3.3 Opbrengsten",
        "para": "1.3.3 Opbrengsten \u2013 paragraaf.md",
        "answers": "1.3.3 Opbrengsten \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
    {
...
@page {
  ...
  @bottom-left   { content: "Hoofdstuk 3 \u2014 Aanbod en kosten"; font-family: Arial, sans-serif; font-size: 9pt; color: #555; }
...
def assemble_answers():
    ...
    parts = ["# Antwoorden Hoofdstuk 3 \u2014 Aanbod en kosten"]
...
if __name__ == "__main__":
    ...
    chapter_md_path = BASE / "1.3 Aanbod en kosten \u2013 hoofdstuk.md"
    ...
    answers_md_path = BASE / "1.3 Aanbod en kosten \u2013 antwoorden.md"
    answers_md_path.write_text(answers_md, encoding="utf-8")
    print(f"Markdown saved: {answers_md_path}")

    # 3. Build PDFs
    print("\n=== Building chapter PDF ===")
    md_to_pdf(chapter_md, "1.3 Aanbod en kosten \u2013 hoofdstuk")

    print("\n=== Building answer booklet PDF ===")
    md_to_pdf(answers_md, "1.3 Aanbod en kosten \u2013 antwoorden")
