...
@page {
  ...
  @bottom-left   { content: "1.3.4 Gemengde opgaven"; font-family: Arial, sans-serif; font-size: 9pt; color: #555; }
...
if __name__ == "__main__":
    ...
    # Build only opgaven and antwoorden (no paragraaf for consolidation)
    for stem in ["opgaven", "antwoorden"]:
        md_file = os.path.join(base, f"1.3.4 Gemengde opgaven \u2013 {stem}.md")
        pdf_file = os.path.join(base, f"1.3.4 Gemengde opgaven \u2013 {stem}.pdf")
