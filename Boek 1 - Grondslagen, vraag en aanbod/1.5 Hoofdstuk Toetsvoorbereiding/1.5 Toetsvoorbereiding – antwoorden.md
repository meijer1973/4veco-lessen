...
*De collectieve vraag is de horizontale optelsom: je berekent per consument de gevraagde hoeveelheid bij P = 3 en telt die op. Anna: 10 − 2(3) = 4. Ben: 8 − 3 = 5. Collectief: 4 + 5 = 9. **Valkuil:** optie A telt de vergelijkingen algebraïsch op (18 − 3P), maar bij P = 3 geeft dat toevallig ook 9 — deze methode werkt hier omdat beide consumenten een positieve Qv hebben, maar is onbetrouwbaar als één consument bij die prijs niets meer vraagt (knik in de collectieve vraaglijn). Optie C vermenigvuldigt in plaats van op te tellen. Optie D behandelt −2P alsof het −2 × P voor de hele collectieve vergelijking is.*
...
*MK = ΔTK/ΔQ = (TK(11) − TK(10)) / (11 − 10). TK(10) = 100 + 2(100) = 300. TK(11) = 100 + 2(121) = 342. MK = (342 − 300) / 1 = 42. **Valkuil:** optie A geeft hetzelfde getal (42), maar berekent het als het verschil in de variabele component (2Q²), niet als ΔTK/ΔQ. Dat levert hier toevallig hetzelfde op, maar de methode is onzuiver — de definitie van MK is altijd ΔTK/ΔQ. Optie B berekent GTK in plaats van MK (delen door Q i.p.v. ΔQ). Optie C gebruikt de afgeleide (4Q), maar past die toe bij Q = 10 in plaats van tussen 10 en 11.*
