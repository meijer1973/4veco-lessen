...
Produces:
  - 1.4 Marktevenwicht en marginale analyse – hoofdstuk.md / .html / .pdf
  - 1.4 Marktevenwicht en marginale analyse – antwoorden.md / .html / .pdf
"""
...
# ---------------------------------------------------------------------------
# Front page content (from blueprint chapter 4: Market Equilibrium & Marginal Analysis)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Paragraph source files (in order) — Chapter 4 has 5 paragraphs
# ---------------------------------------------------------------------------
PARAGRAPHS = [
    {
        "dir": MODULE / "1.4.1 Marktevenwicht",
        "para": "1.4.1 Marktevenwicht \u2013 paragraaf.md",
        "answers": "1.4.1 Marktevenwicht \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
    {
        "dir": MODULE / "1.4.2 Verschuivingen",
        "para": "1.4.2 Verschuivingen \u2013 paragraaf.md",
        "answers": "1.4.2 Verschuivingen \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
    {
        "dir": MODULE / "1.4.3 MK en MO",
        "para": "1.4.3 MK en MO \u2013 paragraaf.md",
        "answers": "1.4.3 MK en MO \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
    {
        "dir": MODULE / "1.4.4 Winstmaximalisatie",
        "para": "1.4.4 Winstmaximalisatie \u2013 paragraaf.md",
        "answers": "1.4.4 Winstmaximalisatie \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
    {
        "dir": MODULE / "1.4.5 Gemengde opgaven",
        "para": "1.4.5 Gemengde opgaven \u2013 opgaven.md",
        "answers": "1.4.5 Gemengde opgaven \u2013 antwoorden.md",
        "asset_prefix": "_assets/",
    },
]
...
@page {
  ...
  @bottom-left   { content: "Hoofdstuk 4 \u2014 Marktevenwicht en marginale analyse"; font-family: Arial, sans-serif; font-size: 9pt; color: #555; }
...
def assemble_answers():
    ...
    parts = ["# Antwoorden Hoofdstuk 4 \u2014 Marktevenwicht en marginale analyse"]
...
if __name__ == "__main__":
    ...
    chapter_md_path = BASE / "1.4 Marktevenwicht en marginale analyse \u2013 hoofdstuk.md"
    ...
    answers_md_path = BASE / "1.4 Marktevenwicht en marginale analyse \u2013 antwoorden.md"
    answers_md_path.write_text(answers_md, encoding="utf-8")
    print(f"Markdown saved: {answers_md_path}")

    # 3. Build PDFs
    print("\n=== Building chapter PDF ===")
    md_to_pdf(chapter_md, "1.4 Marktevenwicht en marginale analyse \u2013 hoofdstuk")

    print("\n=== Building answer booklet PDF ===")
    md_to_pdf(answers_md, "1.4 Marktevenwicht en marginale analyse \u2013 antwoorden")
