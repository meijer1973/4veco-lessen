...
@page {
  ...
  @bottom-left   { content: "1.4.3 MK en MO"; font-family: Arial, sans-serif; font-size: 9pt; color: #555; }
...
if __name__ == "__main__":
    ...
    for stem in ["paragraaf", "opgaven", "antwoorden"]:
        md_file = os.path.join(base, f"1.4.3 MK en MO \u2013 {stem}.md")
        pdf_file = os.path.join(base, f"1.4.3 MK en MO \u2013 {stem}.pdf")
