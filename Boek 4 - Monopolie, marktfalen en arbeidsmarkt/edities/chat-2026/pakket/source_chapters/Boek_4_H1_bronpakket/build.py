...
if __name__=='__main__':
    ...
    (ROOT/'4.1 Monopolie – hoofdstuk.md').write_text('\n\n'.join((ROOT/f).read_text() for f in json.loads((ROOT/'chapter-order.json').read_text())),encoding='utf-8')
    build(pages,'Boek_4_H1_Monopolie','Boek 4 · Hoofdstuk 4.1 · Monopolie')
    for source,stem,title,kind in [('Antwoorden.md','Boek_4_H1_Antwoorden','Antwoorden · Monopolie','answer'),('Docenteninformatie.md','Boek_4_H1_Docenteninformatie','Docenteninformatie · Monopolie','teacher')]:
