...
STAGE=''; SECTION=''
TITLES={'4.2.1':'Welvaartseffecten van monopolie','4.2.2':'Prijsdiscriminatie','4.2.3':'Marktvormen vergelijken','4.2.4':'Negatieve externe effecten','4.2.5':'Positieve externe effecten','4.2.6':'Overheidsingrijpen bij marktfalen','4.2.7':'Gemengde opgaven: marktvormen en marktfalen'}
def section(s):
...
def finish_sources():
    ...
    for s in ['front']+list(TITLES)+['back']:
        ...
        if not pp:continue
        fname={'front':'00 Inleiding.md','back':'08 Overzicht.md'}.get(s,f'{s} manuscript.md')
